...
export const createUser = (userData) => {
  return fetch("http://localhost:5001/api/user/signup", {
    method: "POST",
...
export const createCardio = (cardioData, token) => {
  return fetch("http://localhost:5001/api/exercise/cardio", {
    method: "POST",
    headers: {
      'Content-Type': 'application/json',
      authorization: `Bearer ${token}`,
...
export const createResistance = (resistanceData, token) => {
  return fetch("http://localhost:5001/api/exercise/resistance", {
    method: "POST",
    headers: {
      'Content-Type': 'application/json',
      authorization: `Bearer ${token}`,
...
export const getCardioById = (cardioId, token) => {
  return fetch(`http://localhost:5001/api/exercise/cardio/${cardioId}`, {
    headers: {
      'Content-Type': 'application/json',
      authorization: `Bearer ${token}`,
    }
...
export const getResistanceById = (resistanceId, token) => {
  return fetch(`http://localhost:5001/api/exercise/resistance/${resistanceId}`, {
    headers: {
      'Content-Type': 'application/json',
      authorization: `Bearer ${token}`,
    }
